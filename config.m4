...
[  --with-curl[=DIR]       Include cURL support])
  ...
  if test "$curl_version" -ge 7018000; then
    ...
    AC_MSG_ERROR(cURL version 7.18.0 or later is required to compile php with cURL support)
  fi
...
PHP_ARG_ENABLE(solr, whether to enable solr functions,
...
dnl Setting up the apache Solr 
