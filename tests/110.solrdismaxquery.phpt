...
q=lucene&defType=edismax&qf=location^4 price sku title^3.4&pf=cat~1^3 third~1^4 source^55

Notice: SolrDisMaxQuery::setPhraseFields(): Parameter pf value(s) was overwritten by this call in %s on line %d
q=lucene&defType=edismax&qf=location^4 price sku title^3.4&pf=source^55 cat~1^3